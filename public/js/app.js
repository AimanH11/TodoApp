...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    fetchTodoItems: function fetchTodoItems() {
      var _this2 = this;
      axios__WEBPACK_IMPORTED_MODULE_0___default().get('api/todo').then(function (response) {
        _this2.todoItems = response.data;
      });
    },
    addItem: function addItem() {
      var _this3 = this;
      if (this.newItem.trim() !== "") {
        axios__WEBPACK_IMPORTED_MODULE_0___default().post('/todo', {
          title: this.newItem
        }).then(function () {
          _this3.newItem = "";
    ...
    completeItem: function completeItem(itemId) {
      var _this4 = this;
      axios__WEBPACK_IMPORTED_MODULE_0___default().put("/todo/".concat(itemId), {
        completed: true
      }).then(function () {
        _this4.fetchTodoItems();
      });
    },
    deleteItem: function deleteItem(itemId) {
      var _this5 = this;
      axios__WEBPACK_IMPORTED_MODULE_0___default()["delete"]("/todo/".concat(itemId)).then(function () {
        _this5.fetchTodoItems();
      });
    },
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_2, [_hoisted_3, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    ...
    required: ""
  }, null, 512 /* NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, $data.newItem]]), _hoisted_6])], 32 /* NEED_HYDRATION */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("ul", _hoisted_7, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.todoItems, function (item) {
    ...
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(item.title), 3 /* TEXT, CLASS */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
      onClick: function onClick($event) {
        return $options.completeItem(item.id);
      }
    }, "Complete", 8 /* PROPS */, _hoisted_8), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
      onClick: function onClick($event) {
...
app.component('todo-list', _components_TodoList_vue__WEBPACK_IMPORTED_MODULE_1__["default"]);
app.mount('#app');
})();
